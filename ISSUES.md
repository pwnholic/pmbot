...
**Phase 2 — Correctness:** 6. H1 (deterministic market selection) 7. H8 (risk world state update) 8. H6 + H7 (strategy callbacks) 9. H4 (daily PnL reset) 10. H5 (signal sizing)

**Phase 3 — Polish:** 11. All Medium issues (dead code, unused config, TUI, reconciler) 12. All Low issues (code quality, test coverage)
